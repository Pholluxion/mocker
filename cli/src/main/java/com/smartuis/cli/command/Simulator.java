...
import com.smartuis.cli.config.YamlToJsonConverter;
...
public class Simulator {
    ...
    @ShellMethod(key = "read", value = "Read the container.")
    public String readContainer(String path) {
        YamlToJsonConverter converter = new YamlToJsonConverter();

        try {
            return converter.convertYamlToJson(path);
        } catch (IOException e) {
